      ...
      <!-- Nav Item - Pages Collapse Menu -->
        ...
        <div id="collapseTwoCarga1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" id="libretaDigitalDocente">Planilla de Notas</a>
      ...
      <div class="sidebar-heading">
        ...
        <div id="collapseTwoCarga2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" id="mensajeAlumno">Alumno</a>
     ...
     <!-- Divider -->
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwoCarga4" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Institucional</h6>
            <a class="collapse-item" id="circularesP">Circulares</a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              $conexion = $objeto->Conectar();
                 ...
                 $consulta = "SELECT `idDocente`, `dni`, `nombre`, `domicilio`, `email`, `telefono`, `titulo`, `nregistro` FROM `datos_docentes` WHERE `dni`='$s_usuarioProfesor'";

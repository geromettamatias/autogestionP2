...
if ($cursoSele!='Seleccione ciclo'){

if($planSeleC!='Seleccione un Plan'){

if($planSeleC!=1){
 
$consulta = "SELECT `idCurso`, `idPlan`, `ciclo`, `nombre` FROM `curso` WHERE `ciclo`='$cursoSele' AND `idPlan`='$planSeleC'";
...
?>
    ...
    <button id="btnNuevo_Cursos" type="button" class="btn btn-success" data-toggle="modal">Nuevo</button><br><br> 

...
?>
    ...
    <button id="btnNuevo_Alumno" type="button" class="btn btn-success" data-toggle="modal">Nuevo</button><br><br> 
    ...
    $.ajax({
        ...
        success: function(data){  
            ...
            idPlanEstudio = data[0].idPlanEstudio;
              ...
              $.ajax({
                    url: "modulosCarga/elementos/nombreOrientacion.php",
                    type: "POST",
                    dataType: "json",
                    data: {idPlanEstudio:idPlanEstudio},
                    success: function(data){ 
...
function  eliminarAntesPlanAlumnoFinal(idAlumnos,opcion){
    ...
    if(respuesta){
        ...
        idPlanEstudio='';
        analitico(idAlumnos,idPlanEstudio,opcion);

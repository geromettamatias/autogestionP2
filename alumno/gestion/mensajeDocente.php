...
$consulta = "SELECT `idAlumnos`, `nombreAlumnos`, `dniAlumnos`, `cuilAlumnos`, `domicilioAlumnos`, `emailAlumnos`, `telefonoAlumnos`, `discapasidadAlumnos`, `nombreTutor`, `dniTutor`, `TelefonoTutor`, `idPlanEstudio` FROM `datosalumnos` WHERE `dniAlumnos`='$dniAlumnos'";
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $dat['id_usuario'] ?></td>
                                 ...
                                 $consulta = "SELECT `idDocente`, `dni`, `nombre`, `domicilio`, `email`, `telefono`, `titulo`, `nregistro` FROM `datos_docentes` WHERE `idDocente`='$usuarioDocente'";
                                    $resultado = $conexion->prepare($consulta);
                                    $resultado->execute();
        ...
        <form id="formPersonasMensajeAdmin">    
            ...
            <div class="modal-body">
                ...
                <label for="planSeleC" class="col-form-label">Profesor:</label>
                    ...
                    $consulta = "SELECT `idDocente`, `dni`, `nombre`, `domicilio`, `email`, `telefono`, `titulo`, `nregistro` FROM `datos_docentes` ORDER BY `nombre` ASC";
                    $resultado = $conexion->prepare($consulta);
                    $resultado->execute();
                    $data=$resultado->fetchAll(PDO::FETCH_ASSOC);
